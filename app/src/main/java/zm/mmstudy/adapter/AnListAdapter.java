...
public class AnListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private AndroidFragment fContext;
    private boolean isVertical;
    //    private int[] imgResId;
    public JSONArray lisDate;





    public AnListAdapter(Context mContext, AndroidFragment fContext, boolean isVertical, JSONArray lisDate) {
...
//        this.imgResId = imgResId;
    ...
    public class RecyclerHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            RxBus.getDefault().post(String.valueOf(getLayoutPosition()), fContext.type);
        }
